/* arquivo: public/js/script.js - script do frontend: funcionalidades relacionadas a script - funções/constantes: accordionItems, buscarLocalizacao, menuButton, lon, lat */
